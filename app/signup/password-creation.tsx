...
import { ArrowLeft, ArrowRight, Key, Eye, EyeOff, CircleAlert as AlertCircle, CircleCheck as CheckCircle, Shield, Mail } from 'lucide-react-native';
      ...
      <SafeAreaView style={[styles.container, { backgroundColor: isDark ? '#0F172A' : '#F1F5F9' }]}>
        <View style={styles.successContainer}>
          ...
          <Text style={[styles.successMessage, { color: isDark ? '#9CA3AF' : '#6B7280' }]}>
            Please check your email at {signUpData.email} to confirm your account before signing in.
          </Text>
